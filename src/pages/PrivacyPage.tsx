...
export function PrivacyPage() {
  return (
    <>
      ...
      <SEO title="Privacy | The Webpage Builder" description="The Webpage Builder - Privacy. Premium 3D web development and custom AI software agency." url="https://thewebpagebuilder.in/privacy" />{/* Page Hero */}
